    ...
    protected void btn_Delete_Click(object sender, EventArgs e)
    {
        for (int i = 0; i < GridView1.Rows.Count; i++)
        {
            ...
            for (int j = 0; j < cb.Length; j++)
            {
                ...
                {
                    Label LEAVE_ID = (Label)GridView1.Rows[i].FindControl("Label4");
                    String sql = "", str = "";
                    ...
                    conn.Open();
                    sql = "delete LEAVE WHERE LEAVE_ID='" + LEAVE_ID.Text +"'" ;
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="選取">
                        <ItemTemplate>
                            ...
                            <asp:Label ID="Label4" runat="server" Text='<%# Eval("編號") %>'></asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
