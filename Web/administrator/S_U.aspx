...
<script runat="server">
    ...
    { 
        ...
        conn.Open(); 
        sql = "Update STUDENT set STUDENT_ID='" + tbx_sid.Text.Trim() + "', STUDENT_NAME='" + tbx_sname.Text.Trim() + "', DEPARTMENT_ID='" + tbx_did.Text.Trim() + "', CLASS_ID='" + tbx_cid.Text.Trim() + "', STUDENT_PW='" + tbx_spw.Text.Trim() + "' where STUDENT_ID='" + tbx_sid.Text.Trim() + "'"; 
        Label3.Text = sql; 
        SqlCommand cmd = new SqlCommand(sql, conn); 
        SqlDataReader reader = cmd.ExecuteReader(); 
        sql = "Select * from STUDENT where STUDENT_ID='" + tbx_sid.Text.Trim() + "'"; 
        reader.Close(); 
        cmd.CommandText = sql; 
    ...
    { 
        ...
        if (reader.Read()) 
        { 
            tbx_sid.Text = reader[0].ToString(); 
            tbx_sname.Text = reader[1].ToString(); 
            tbx_did.Text = reader[2].ToString(); 
            tbx_cid.Text = reader[3].ToString();
            tbx_spw.Text = reader[4].ToString();
...
<body>
    <form id="form1" runat="server">
            ...
            <asp:TreeView ID="TreeView1" runat="server" Font-Size="20pt" style="margin-right: 1px">
                <Nodes>
                    <asp:TreeNode NavigateUrl="~/administrator/A_index.aspx" Text="首頁" Value="點名" Expanded="True">
                        <asp:TreeNode Text="學生" Value="學生" Expanded="True">
        ...
        <div id="bimg2">
            <asp:Label ID="Label2" runat="server" Text="請  更  新  學  生  基  本  資  料" Font-Size="XX-Large"></asp:Label>
            <br />
            <br />
            <asp:Label ID="lbl_sid" runat="server" Text="學生代號："></asp:Label>
            <asp:TextBox ID="tbx_sid" runat="server"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="lbl_sname" runat="server" Text="學生姓名："></asp:Label>
            ...
            <br />
            <br />
            <asp:Label ID="lbl_spw" runat="server" Text="學生密碼："></asp:Label>
            <asp:TextBox ID="tbx_spw" runat="server"></asp:TextBox>
            <br />
            <br />
