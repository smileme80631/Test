...
<script runat="server">
    ...
    { 
        ...
        conn.Open(); 
        sql = "Update SESSION set SESSION_ID='" + tbx_seid.Text.Trim() + "', STARTTIME='" + tbx_st.Text.Trim() + "', ENDTIME='" + tbx_et.Text.Trim() + "' where SESSION_ID='" + tbx_seid.Text.Trim() + "'"; 
        Label3.Text = sql; 
        SqlCommand cmd = new SqlCommand(sql, conn); 
        SqlDataReader reader = cmd.ExecuteReader(); 
        sql = "Select * from SESSION where SESSION_ID='" + tbx_seid.Text.Trim() + "'"; 
        reader.Close(); 
        cmd.CommandText = sql; 
    ...
    { 
        ...
        if (reader.Read()) 
        { 
            tbx_seid.Text = reader[0].ToString(); 
            tbx_st.Text = reader[1].ToString(); 
            tbx_et.Text = reader[2].ToString(); 
...
<body>
    <form id="form1" runat="server">
            ...
            <asp:TreeView ID="TreeView1" runat="server" Font-Size="20pt" style="margin-right: 1px">
                <Nodes>
                    <asp:TreeNode NavigateUrl="~/administrator/A_index.aspx" Text="首頁" Value="點名" Expanded="True">
                        ...
                        <asp:TreeNode Expanded="True" Text="節次" Value="節次">
        ...
        <div id="bimg2">
            <asp:Label ID="Label2" runat="server" Text="請  更  新  節  次  資  料" Font-Size="XX-Large"></asp:Label>
            <br />
            <br />
            <asp:Label ID="lbl_seid" runat="server" Text="節次編號："></asp:Label>
            <asp:TextBox ID="tbx_seid" runat="server"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="lbl_st" runat="server" Text="開始時間："></asp:Label>
            <asp:TextBox ID="tbx_st" runat="server"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="lbl_et" runat="server" Text="結束時間："></asp:Label>
            <asp:TextBox ID="tbx_et" runat="server"></asp:TextBox>
            <br />
            <br /> 
