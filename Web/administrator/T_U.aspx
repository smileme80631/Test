...
<script runat="server">
    ...
    { 
        ...
        conn.Open(); 
        sql = "Update TEACHER set TEACHER_ID='" + tbx_tid.Text.Trim() + "', TEACHER_NAME='" + tbx_tname.Text.Trim() + "', DEPARTMENT_ID='" + tbx_did.Text.Trim() + "', CLASS_ID='" + tbx_cid.Text.Trim() + "', TEACHER_PW='" + tbx_tpw.Text.Trim() + "' where TEACHER_ID='" + tbx_tid.Text.Trim() + "'"; 
        Label3.Text = sql; 
        SqlCommand cmd = new SqlCommand(sql, conn); 
        SqlDataReader reader = cmd.ExecuteReader(); 
        sql = "Select * from TEACHER where TEACHER_ID='" + tbx_tid.Text.Trim() + "'"; 
        reader.Close(); 
        cmd.CommandText = sql; 
    ...
    { 
        ...
        if (reader.Read()) 
        { 
            tbx_tid.Text = reader[0].ToString(); 
            tbx_tname.Text = reader[1].ToString(); 
            tbx_did.Text = reader[2].ToString(); 
            tbx_cid.Text = reader[3].ToString();
            tbx_tpw.Text = reader[4].ToString();
...
<body>
    <form id="form1" runat="server">
            ...
            <asp:TreeView ID="TreeView1" runat="server" Font-Size="20pt" style="margin-right: 1px">
                <Nodes>
                    <asp:TreeNode NavigateUrl="~/administrator/A_index.aspx" Text="首頁" Value="點名" Expanded="True">
                        ...
                        <asp:TreeNode Text="教師" Value="教師" Expanded="True">
        ...
        <div id="bimg2">
            <asp:Label ID="Label2" runat="server" Text="請  更  新  教  師  基  本  資  料" Font-Size="XX-Large"></asp:Label>
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:Label ID="lbl_tname" runat="server" Text="教師姓名："></asp:Label>
            <asp:TextBox ID="tbx_tname" runat="server"></asp:TextBox>
            <br />
            <br />
            ...
            <br />
            <br />
            <asp:Label ID="lbl_cid" runat="server" Text="班級編號："></asp:Label>
            <asp:TextBox ID="tbx_cid" runat="server"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="lbl_tpw" runat="server" Text="教師密碼："></asp:Label>
            <asp:TextBox ID="tbx_tpw" runat="server"></asp:TextBox>
            <br />
            <br />
