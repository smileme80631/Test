...
<script runat="server">
    ...
    { 
        ...
        conn.Open(); 
        sql = "Update DEPARTMENT set DEPARTMENT_ID='" + tbx_DEPARTMENTID.Text.Trim() + "', DEPARTMENT_NAME='" + tbx_DEPARTMENTNAME.Text.Trim()+ "' where DEPARTMENT_ID='" + tbx_DEPARTMENTID.Text.Trim() + "'"; 
        Label3.Text = sql; 
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="bimg2">
            <asp:Label ID="Label2" runat="server" Text="請  更  新  科  系  資  料" Font-Size="XX-Large"></asp:Label>
            <br />
            <br />
