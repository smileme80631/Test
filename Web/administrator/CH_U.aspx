...
<script runat="server">
    ...
    { 
        ...
        conn.Open(); 
        sql = "Update CHOOSECLASS set CHOOSECLASS_ID='" + tbx_chooseid.Text.Trim() + "', STUDENT_ID='" + tbx_sid.Text.Trim() + "', COURSE_ID='" + tbx_cid.Text.Trim()+ "'where CHOOSECLASS_ID='" + tbx_chooseid.Text.Trim() + "'"; 
        Label3.Text = sql; 
        SqlCommand cmd = new SqlCommand(sql, conn); 
        SqlDataReader reader = cmd.ExecuteReader(); 
        sql = "Select * from CHOOSECLASS where CHOOSECLASS_ID='" + tbx_chooseid.Text.Trim() + "'"; 
        reader.Close(); 
        cmd.CommandText = sql; 
    ...
    { 
        ...
        if (reader.Read()) 
        { 
            tbx_chooseid.Text = reader[0].ToString();
            tbx_sid.Text = reader[1].ToString();
            tbx_cid.Text = reader[2].ToString();
        } 
        else 
        { 
        tbx_chooseid.Text = "";
...
<body>
    <form id="form1" runat="server">
            ...
            <asp:TreeView ID="TreeView1" runat="server" Font-Size="20pt" style="margin-right: 1px">
                <Nodes>
                    <asp:TreeNode NavigateUrl="~/administrator/A_index.aspx" Text="首頁" Value="點名" Expanded="True">
                        ...
                        <asp:TreeNode Text="修課" Value="修課" Expanded="True">
        ...
        <div id="bimg2">
            <asp:Label ID="Label2" runat="server" Text="請  更  新  修  課  資  料" Font-Size="XX-Large"></asp:Label>
            <br />
            <br />
            <asp:Label ID="lbl_chooseid" runat="server" Text="修課編號："></asp:Label>
            <asp:TextBox ID="tbx_chooseid" runat="server"></asp:TextBox>
            <br />
            <br />
