...
<script runat="server">
    ...
    protected void btn_add_Click(object sender, EventArgs e)
    {
        ...
        SqlConnection conn = new SqlConnection(sqldb);
        conn.Open();
        sql = "Insert into DEPARTMENT values('" + tbx_DEPARTMENTID.Text.Trim() + "','" + tbx_DEPARTMENTNAME.Text.Trim() +"')";
        SqlCommand cmd = new SqlCommand(sql, conn);
        SqlDataReader reader = cmd.ExecuteReader();
        Label3.Text = "<table border='1'><tr align='Center'>";
        for (int i = 0; i < reader.FieldCount; i++)
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="bimg2">
            <asp:Label ID="Label2" runat="server" Text="請  輸  入  科  系  資  料" Font-Size="XX-Large"></asp:Label>
            <br />
            <br />
