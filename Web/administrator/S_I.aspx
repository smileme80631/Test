...
<script runat="server">
    ...
    protected void btn_add_Click(object sender, EventArgs e)
    {
        String sql = "";
        Label3.Text = "";
        String sqldb = @"Data Source=localhost\SQLEXPRESS;Initial Catalog=look;User ID=sa;Password=1234";
        SqlConnection conn = new SqlConnection(sqldb);
        conn.Open();
        sql = "Insert into STUDENT values('" + tbx_sid.Text.Trim() + "','" + tbx_sname.Text.Trim() + "','" + tbx_did.Text.Trim() + "','"+tbx_cid.Text.Trim()+"','"+tbx_spw.Text.Trim()+"')";
        SqlCommand cmd = new SqlCommand(sql, conn);
        SqlDataReader reader = cmd.ExecuteReader();
        Label3.Text = "<table border='1'><tr align='Center'>";
        for (int i = 0; i < reader.FieldCount; i++)
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="bimg2">
            <asp:Label ID="Label2" runat="server" Text="請  輸  入  學  生  基  本  資  料" Font-Size="XX-Large"></asp:Label>
            <br />
            <br />
