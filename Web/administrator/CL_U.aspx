...
<script runat="server">
    ...
    protected void btn_Update_Click(object sender, EventArgs e)
    {
        ...
        conn.Open();
        sql = "Update CLASS set CLASS_ID='" + tbx_clid.Text.Trim() + "', CLASS_NAME='" + tbx_clname.Text.Trim() + "', DEPARTMENT_ID='" + tbx_did.Text.Trim() + "', CLASS_YEAR='" + tbx_cly.Text.Trim() + "' where CLASS_ID='" + tbx_clid.Text.Trim() + "'";
        Label3.Text = sql;
        SqlCommand cmd = new SqlCommand(sql, conn);
        SqlDataReader reader = cmd.ExecuteReader();
        sql = "Select * from CLASS where CLASS_ID='" + tbx_clid.Text.Trim() + "'";
        reader.Close();
        cmd.CommandText = sql;
    ...
    protected void btn_Choose_Click(object sender, EventArgs e)
    {
        ...
        if (reader.Read())
        {
            tbx_clid.Text = reader[0].ToString();
            tbx_clname.Text = reader[1].ToString();
            tbx_did.Text = reader[2].ToString();
            tbx_cly.Text = reader[3].ToString();
        }
        else
        {
            tbx_clid.Text = "";
...
<body>
    <form id="form1" runat="server">
        ...
        <div id="bimg2">
            <asp:Label ID="Label2" runat="server" Text="請  更  新  班  級  資  料" Font-Size="XX-Large"></asp:Label>
            <br />
            <br />
