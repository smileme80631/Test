...
<script runat="server">
    ...
    protected void btn_Update_Click(object sender, EventArgs e)
    {
        ...
        conn.Open();
        sql = "Update COURSE set COURSE_ID='" + tbx_cid.Text.Trim() + "', COURSE_NAME='" + tbx_cname.Text.Trim() + "', TEACHER_ID='" + tbx_tid.Text.Trim()+ "', CLASS_ID='" + tbx_clid.Text.Trim() + "', WEEK='" + tbx_w.Text.Trim()+ "', SESSION_ID='" + tbx_seid.Text.Trim() + "', CLASSROOM_ID='" + tbx_crid.Text.Trim()+ "' where COURSE_ID='" + tbx_cid.Text.Trim() + "'";
        Label3.Text = sql;
        SqlCommand cmd = new SqlCommand(sql, conn);
        SqlDataReader reader = cmd.ExecuteReader();
        sql = "Select * from COURSE where COURSE_ID='" + tbx_cid.Text.Trim() + "'";
        reader.Close();
        cmd.CommandText = sql;
    ...
    protected void btn_Choose_Click(object sender, EventArgs e)
    {
        ...
        if (reader.Read())
        {
            ...
            tbx_cname.Text = reader[1].ToString();
            tbx_tid.Text = reader[2].ToString();
            tbx_clid.Text = reader[3].ToString();
            tbx_w.Text = reader[4].ToString();
            tbx_seid.Text = reader[5].ToString();
            tbx_crid.Text = reader[6].ToString();
        }
        else
        {
            tbx_cid.Text = "";
...
<body>
    <form id="form1" runat="server">
            ...
            <asp:TreeView ID="TreeView1" runat="server" Font-Size="20pt" style="margin-right: 1px">
                <Nodes>
                    <asp:TreeNode NavigateUrl="~/administrator/A_index.aspx" Text="首頁" Value="點名" Expanded="True">
                        ...
                        <asp:TreeNode Text="課程" Value="課程" Expanded="True">
        ...
        <div id="bimg2">
            <asp:Label ID="Label2" runat="server" Text="請  更  新  課  程  資  料" Font-Size="XX-Large"></asp:Label>
            <br />
            <br />
            <asp:Label ID="lbl_cid" runat="server" Text="課程編號："></asp:Label>
            <asp:TextBox ID="tbx_cid" runat="server"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="lbl_cname" runat="server" Text="課程名稱："></asp:Label>
            <asp:TextBox ID="tbx_cname" runat="server"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="lbl_tid" runat="server" Text="教師代號："></asp:Label>
            <asp:TextBox ID="tbx_tid" runat="server"></asp:TextBox>
            <br />
            <br />
            ...
            <br />
            <br />            
            <asp:Label ID="lbl_w" runat="server" Text="星期："></asp:Label>
            <asp:TextBox ID="tbx_w" runat="server"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="lbl_seid" runat="server" Text="節次："></asp:Label>
            <asp:TextBox ID="tbx_seid" runat="server"></asp:TextBox>
            <br />
            <br />
            <asp:Label ID="lbl_crid" runat="server" Text="教室："></asp:Label>
            <asp:TextBox ID="tbx_crid" runat="server"></asp:TextBox>
            <br />
            <br />
